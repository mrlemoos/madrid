...
import UserPlusIcon from './user-plus-icon.js';
...
describe('UserPlusIcon', () => {
  it('renders one svg sized and coloured by its props', () => {
    ...
    const { container } = render(
      <UserPlusIcon size={18} color="rebeccapurple" strokeWidth={1.5} />,
    );
  ...
  it('falls back to a 24px currentColor icon', () => {
    // Arrange|Act
    const { container } = render(<UserPlusIcon />);
