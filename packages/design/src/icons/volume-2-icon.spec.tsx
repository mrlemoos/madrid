...
import Volume2Icon from './volume-2-icon.js';
...
describe('Volume2Icon', () => {
  it('renders one svg sized and coloured by its props', () => {
    ...
    const { container } = render(
      <Volume2Icon size={18} color="rebeccapurple" strokeWidth={1.5} />,
    );
  ...
  it('falls back to a 24px currentColor icon', () => {
    // Arrange|Act
    const { container } = render(<Volume2Icon />);
