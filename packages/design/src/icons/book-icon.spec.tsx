...
import BookIcon from './book-icon.js';
...
describe('BookIcon', () => {
  it('renders one svg sized and coloured by its props', () => {
    ...
    const { container } = render(
      <BookIcon size={18} color="rebeccapurple" strokeWidth={1.5} />,
    );
    ...
    // stroke scales with the viewBox so the stroke reads the same at 24px
