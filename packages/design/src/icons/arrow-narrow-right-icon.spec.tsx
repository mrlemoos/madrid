...
import ArrowNarrowRightIcon from './arrow-narrow-right-icon.js';
import type { AnimatedIconHandle } from './types.js';

describe('ArrowNarrowRightIcon', () => {
  ...
  it('falls back to a 24px currentColor icon', () => {
    // Arrange|Act
    const { container } = render(<ArrowNarrowRightIcon />);
  ...
  it('exposes start and stop animation through its ref', () => {
    ...
    // Act
    render(<ArrowNarrowRightIcon ref={ref} />);
