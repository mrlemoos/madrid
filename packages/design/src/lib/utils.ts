/**
 * Tailwind-friendly class name merging for `@nota/design` and app re-exports.
 *
 * @remarks
 * Import from the package subpath only: `import { cn, type ClassValue } from '@nota/design/utils'`.
